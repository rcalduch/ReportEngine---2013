...
Public Class R90CTB0042A_Explotacio
    ...
    Public Overrides Sub Execute(workInfo As String)
        ...
        Try
            ...
            rpt.TitolLlistat = CNull(params.GetValue("TitolLlistat")).Replace("BALANCE DE EXPLOTACION", "BALANÇ D'EXPLOTACIÓ")
        ...
        Catch ex As Exception
            ...
            DebugLog(AppData.Debug, Date.Now.ToString("dd/MM/yyyy HH:mm:ss") + " R90CTB0042A_Explotacio " + ex.Message)
...
Public Class R90CTB0042C_Explotacio
...
#End Region
    ...
    Private Sub PrintHeader(ByVal Canvas As System.Drawing.Graphics)
        ...
        curX += ColumnWidth(col) + ColumnGap : col += 1
        DrawString(Canvas, "SALDO PERIODE", fntLineB, Brushes.Black, New RectangleF(curX, CurY, ColumnWidth(col), 14), sfFar)
        curX += ColumnWidth(col) + ColumnGap : col += 1
        DrawString(Canvas, "SALDO ACTUAL", fntLineB, Brushes.Black, New RectangleF(curX, CurY, ColumnWidth(col), 14), sfFar)
    ...
    Private Function DrawLinBalansSit(ByVal Canvas As System.Drawing.Graphics) As Boolean
        ...
        If Titol.StartsWith("COMPTES") And String.IsNullOrWhiteSpace(Compte) Then
            ...
            DrawString(Canvas, Titol, fntTitle, Brushes.Black, New RectangleF(curX, CurY, 350, 16), sfNear)
            CurY += deltaLine \ 2

        ElseIf (Titol.StartsWith("TOTAL") Or Titol.StartsWith("PREVISIO DE RESULTATS:") Or Titol.StartsWith("EXISTENCIES INICIALS:")) And String.IsNullOrWhiteSpace(Compte) Then
        ...
        Else
            ...
            curX += ColumnWidth(col) + ColumnGap : col += 1
            DrawString(Canvas, fmtValueToStr(lin("SD_PERIODE"), 2, False), fnt2Use, Brushes.Black, New RectangleF(curX, CurY, ColumnWidth(col), 12), sfFar)
            curX += ColumnWidth(col) + ColumnGap : col += 1
    ...
    Private Sub clsImpresFactura_GetDataSource() Handles Me.GetDataSource
        ...
        Try
            ...
            lin = New csTableReader(dbaRpt.get_balans_explotacio)
        ...
        Catch ex As Exception
            DataLoaded = False
            DebugLog(AppData.Debug, Date.Now.ToString("dd/MM/yyyy HH:mm:ss") + " C00_ctb_exp " + ex.Message)
        End Try
...
#Region " Print "
    ...
    Private Sub Execute()
        ...
        ReportName = "Balanç Explotació"
        ReportID = "R90CTB0042C_EXP"
